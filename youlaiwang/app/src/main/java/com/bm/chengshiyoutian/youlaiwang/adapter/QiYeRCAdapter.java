...
public class QiYeRCAdapter extends RecyclerView.Adapter<QiYeRCAdapter.MyViewHolder> {

    private OnItemClickListener mOnItemClickListener = null;
    Context context;
    List<String> company_license;

    public QiYeRCAdapter(Context context, List<String> company_license) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        try {
            ...
            Glide.with(context)
                    .load(R.mipmap.zhengjianshangchuan).centerCrop()
                    .into(holder.imageView);
        }
