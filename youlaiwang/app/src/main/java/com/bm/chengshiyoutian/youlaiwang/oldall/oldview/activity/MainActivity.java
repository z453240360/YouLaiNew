    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.ll_cooking_oil_declare: //食用油采购(废弃油)
               /*if (TextUtils.isEmpty(App.getInstance().getUser().id)) {
            ...
            case R.id.ll_shengchan://生产
                ...
                if (TextUtils.isEmpty(MyApplication.getInstance().getUser().id)) {
                    ...
                    /*intent = new Intent(getApplicationContext(), DemandingCertificatesActivity.class);
    ...
    private void declareOil(String bundleString) {
        ...
        if ("2".equals(mStatesAction)) {
            ...
            mTipDialog.setOnClickListener(new TipDialog.OnClickListener() {
                ...
                public void onClick(View v) {
                    mTipDialog.dismiss();
                    startActivity(new Intent(MainActivity.this, RefuseOilDeclareActivity.class));
                }
            });
        }
    }
    ...
    private void logout() {
        ...
        mTipDialog.setOnClickListener(new TipDialog.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTipDialog.dismiss();
                startActivity(new Intent(MainActivity.this, LoginActivtiy.class));
            }
        });
