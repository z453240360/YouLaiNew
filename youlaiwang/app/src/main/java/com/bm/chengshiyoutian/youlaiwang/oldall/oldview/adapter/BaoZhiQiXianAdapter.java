...
public class BaoZhiQiXianAdapter extends BaseAdapter {
    ...
    public BaoZhiQiXianAdapter(Context context, DialogSelectTimeInterface dialogSelectTime) {
        mContext = context;
...
//        }
    ...
    private void setListener(final TextView tv_add_baozhi_qixian, final TextView tv_shengchan_pihao, final int position) {
        tv_add_baozhi_qixian.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mDialogSelectTime != null) {
                    mDialogSelectTime.selectTime(0, tv_add_baozhi_qixian, position);
                }
            }
        });
        //生产批号
        tv_shengchan_pihao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mDialogSelectTime != null) {
                    mDialogSelectTime.selectTime(1, tv_shengchan_pihao, position);
                }
            }
        });
    }
