 ...
 * Description:(类的用途)
 */
public class AccountDetailNextBaseAdapter extends BaseAdapter {
    ...
    private int index = -1;
    public AccountDetailNextBaseAdapter(Context context, List<AccountDetailBean> mdatas, AddCallBackListener addListener, SubtractCallBackListener subtractListener, GuiGeCallBackListener guiGeListener) {
