...
public class MyTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private MyTimePickerView.Type type;// 显示类型
    ...
    //构造方法
    public MyTimePickerView(Builder builder) {
    ...
    public static class Builder {
        ...
        private MyTimePickerView.Type type = Type.ALL;//显示类型 默认全部显示
        private int gravity = Gravity.CENTER;//内容显示位置 默认居中
        ...
        //Option
        public Builder setType(MyTimePickerView.Type type) {
            this.type = type;
            return this;
        }
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            tvTitle.setText("请选择时间段");//默认为空

            //设置文字颜色
            btnSubmit.setTextColor(0xffffffff);
            btnCancel.setTextColor(0xff0bb04a);
            ...
            rv_top_bar.setBackgroundColor(0xff0bb04a);
        } else {
        ...
        timePickerView1.setBackgroundColor(Color_Background_Wheel == 0 ? bgColor_default : Color_Background_Wheel);
        wheelTime = new MyWheelTime(timePickerView, type, gravity, Size_Content,timePickerView1);
   ...
   public void setDate(Calendar date) {
    ...
    public void returnData() {
        if (timeSelectListener != null) {
            try {
                ...
                Date date1 = MyWheelTime.dateFormat.parse(wheelTime.getTime1());
                timeSelectListener.onTimeSelect(date, clickView,date1);
    ...
    public interface OnTimeSelectListener {
        void onTimeSelect(Date date, View v, Date date1);
    }
