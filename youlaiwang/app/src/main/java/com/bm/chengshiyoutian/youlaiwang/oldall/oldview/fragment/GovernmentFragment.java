 ...
 * @Description 政府消息
 */
public class GovernmentFragment extends Fragment implements BaseInterface {
    ...
    public void init() {
        ...
        getInfoList(MyApplication.getInstance().getUser().id, "2", String.valueOf(pageIndexInt));
    }
