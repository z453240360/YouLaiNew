...
public class MyWheelTime {
    ...
    private WheelView wv_year1;
    private WheelView wv_month1;
    private WheelView wv_day1;

    private WheelView wv_hours1;
    private WheelView wv_mins1;
    private WheelView wv_seconds1;
    ...
    public MyWheelTime(View view, MyTimePickerView.Type type, int gravity, int textSize,View view1) {
        super();
        this.view = view;
        this.type = type;
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        ...
        wv_year1 = (WheelView) view1.findViewById(R.id.year1);
        wv_year.setitemsVisible(5);
        wv_year1.setitemsVisible(5);
        wv_year.setAdapter(new NumericWheelAdapter(startYear, endYear));// 设置"年"的显示数据
        wv_year1.setAdapter(new NumericWheelAdapter(startYear, endYear));// 设置"年"的显示数据
        /*wv_year.setLabel(context.getString(R.string.pickerview_year));// 添加文字*/
        wv_year.setCurrentItem(year - startYear);// 初始化时显示的数据
        wv_year.setGravity(gravity);
        wv_year1.setCurrentItem(year - startYear);// 初始化时显示的数据
        wv_year1.setGravity(gravity);
        // 月
        wv_month = (WheelView) view.findViewById(R.id.month);
        wv_month1 = (WheelView) view1.findViewById(R.id.month1);
        wv_month.setitemsVisible(5);
        wv_month1.setitemsVisible(5);
        if (startYear == endYear) {//开始年等于终止年
            ...
            wv_month1.setAdapter(new NumericWheelAdapter(startMonth, endMonth));
            wv_month1.setCurrentItem(month + 1 - startMonth);
        } else if (year == startYear) {
            //起始日期的月份控制
            wv_month.setAdapter(new NumericWheelAdapter(startMonth, 12));
            wv_month.setCurrentItem(month + 1 - startMonth);
            wv_month1.setAdapter(new NumericWheelAdapter(startMonth, 12));
            wv_month1.setCurrentItem(month + 1 - startMonth);
        } else if (year == endYear) {
            //终止日期的月份控制
            wv_month.setAdapter(new NumericWheelAdapter(1, endMonth));
            wv_month.setCurrentItem(month);
            wv_month1.setAdapter(new NumericWheelAdapter(1, endMonth));
            wv_month1.setCurrentItem(month);
        } else {
            wv_month.setAdapter(new NumericWheelAdapter(1, 12));
            wv_month.setCurrentItem(month);
            wv_month1.setAdapter(new NumericWheelAdapter(1, 12));
            wv_month1.setCurrentItem(month);
        }
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/

        wv_month.setGravity(gravity);
        wv_month1.setGravity(gravity);
        // 日
        wv_day = (WheelView) view.findViewById(R.id.day);
        wv_day1 = (WheelView) view1.findViewById(R.id.day1);
        wv_day.setitemsVisible(5);
        wv_day1.setitemsVisible(5);
        if (startYear == endYear && startMonth == endMonth) {
            if (list_big.contains(String.valueOf( month + 1))) {
                ...
                wv_day1.setAdapter(new NumericWheelAdapter(startDay, endDay));
            ...
            if (list_big.contains(String.valueOf(month + 1 ))) {
                ...
                wv_day1.setAdapter(new NumericWheelAdapter(1, endDay));
            } else if (list_little.contains(String.valueOf(month + 1 ))) {
                if (endDay > 30) {
                    endDay = 30;
                }
            ...
            wv_day1.setCurrentItem(day - 1);
        } else {
            // 判断大小月及是否闰年,用来确定"日"的数据
            if (list_big.contains(String.valueOf(month + 1))) {

                wv_day.setAdapter(new NumericWheelAdapter(1, 31));
                wv_day1.setAdapter(new NumericWheelAdapter(1, 31));
            } else if (list_little.contains(String.valueOf(month + 1 ))) {

                wv_day.setAdapter(new NumericWheelAdapter(1, 30));
                wv_day1.setAdapter(new NumericWheelAdapter(1, 30));
            } else {
                // 闰年
                if ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) {

                    wv_day.setAdapter(new NumericWheelAdapter(1, 29));
                    wv_day1.setAdapter(new NumericWheelAdapter(1, 29));
                } else {

                    wv_day.setAdapter(new NumericWheelAdapter(1, 28));
                    wv_day1.setAdapter(new NumericWheelAdapter(1, 28));
                }
            }
            wv_day.setCurrentItem(day - 1);
            wv_day1.setCurrentItem(day - 1);
      ...
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
        ...
        wv_hours1 = (WheelView) view1.findViewById(R.id.hour1);
        wv_hours1.setAdapter(new NumericWheelAdapter(0, 23));
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
        wv_hours1.setCurrentItem(h);
        wv_hours1.setGravity(gravity);
        //分
       ...
       /* wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字*/
        ...
        //分
        wv_mins1 = (WheelView) view1.findViewById(R.id.min1);
        wv_mins1.setAdapter(new NumericWheelAdapter(0, 59));
       /* wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字*/
        wv_mins1.setCurrentItem(m);
        wv_mins1.setGravity(gravity);
        //秒
       ...
       /* wv_seconds.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字*/
        ...
        //秒
        wv_seconds1 = (WheelView) view1.findViewById(R.id.second1);
        wv_seconds1.setAdapter(new NumericWheelAdapter(0, 59));
       /* wv_seconds.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字*/
        wv_seconds1.setCurrentItem(s);
        wv_seconds1.setGravity(gravity);
        ...
        // 添加"年"监听
        OnItemSelectedListener wheelListener_year1 = new OnItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {
                int year_num = index + startYear;
                currentYear = year_num;
                int currentMonthItem = wv_month1.getCurrentItem();//记录上一次的item位置
                // 判断大小月及是否闰年,用来确定"日"的数据
                if (startYear == endYear) {
                    //重新设置月份
                    wv_month1.setAdapter(new NumericWheelAdapter(startMonth, endMonth));

                    if (currentMonthItem > wv_month1.getAdapter().getItemsCount() - 1) {
                        currentMonthItem = wv_month1.getAdapter().getItemsCount() - 1;
                        wv_month1.setCurrentItem(currentMonthItem);
                    }
        ...
        // 添加"月"监听
        OnItemSelectedListener wheelListener_month1 = new OnItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {
                int month_num = index + 1;
                ...
                if (startYear == endYear) {
                    ...
                    if (month_num == endMonth) {
                        //重新设置日
                        setReDay(currentYear, wv_month1.getCurrentItem() + 1, 1, endDay, list_big, list_little);
                    } else {
                        setReDay(currentYear, wv_month1.getCurrentItem() + 1, 1, 31, list_big, list_little);
                    }
        ...
        wv_year1.setOnItemSelectedListener(wheelListener_year1);
        wv_month1.setOnItemSelectedListener(wheelListener_month1);
        ...
        switch (type) {
            ...
            case YEAR_MONTH_DAY:
               /* textSize = textSize * 4;*/
                ...
                wv_hours1.setVisibility(View.GONE);
                wv_mins1.setVisibility(View.GONE);
                wv_seconds1.setVisibility(View.GONE);
                break;
            case HOURS_MINS:
                /*textSize = textSize * 4;*/
                ...
                wv_year1.setVisibility(View.GONE);
                wv_month1.setVisibility(View.GONE);
                wv_day1.setVisibility(View.GONE);
                wv_seconds1.setVisibility(View.GONE);
                break;
    ...
    private void setContentTextSize() {
        ...
        wv_day1.setTextSize(textSize);
        wv_month1.setTextSize(textSize);
        wv_year1.setTextSize(textSize);
        wv_hours1.setTextSize(textSize);
        wv_mins1.setTextSize(textSize);
        wv_seconds1.setTextSize(textSize);
    }
    ...
    private void setTextColorOut() {
        ...
        wv_day1.setTextColorOut(textColorOut);
        wv_month1.setTextColorOut(textColorOut);
        wv_year1.setTextColorOut(textColorOut);
        wv_hours1.setTextColorOut(textColorOut);
        wv_mins1.setTextColorOut(textColorOut);
        wv_seconds1.setTextColorOut(textColorOut);
    }
    ...
    private void setTextColorCenter() {
        ...
        wv_day1.setTextColorCenter(textColorCenter);
        wv_month1.setTextColorCenter(textColorCenter);
        wv_year1.setTextColorCenter(textColorCenter);
        wv_hours1.setTextColorCenter(textColorCenter);
        wv_mins1.setTextColorCenter(textColorCenter);
        wv_seconds1.setTextColorCenter(textColorCenter);
    }
    ...
    private void setDividerColor() {
        ...
        wv_day1.setDividerColor(dividerColor);
        wv_month1.setDividerColor(dividerColor);
        wv_year1.setDividerColor(dividerColor);
        wv_hours1.setDividerColor(dividerColor);
        wv_mins1.setDividerColor(dividerColor);
        wv_seconds1.setDividerColor(dividerColor);
    }
    ...
    private void setDividerType() {
        ...
        wv_seconds.setDividerType(dividerType);
         ...
         wv_day1.setDividerType(dividerType);
        wv_month1.setDividerType(dividerType);
        wv_year1.setDividerType(dividerType);
        wv_hours1.setDividerType(dividerType);
        wv_mins1.setDividerType(dividerType);
        wv_seconds1.setDividerType(dividerType);
    ...
    private void setLineSpacingMultiplier() {
        ...
        wv_day1.setLineSpacingMultiplier(lineSpacingMultiplier);
        wv_month1.setLineSpacingMultiplier(lineSpacingMultiplier);
        wv_year1.setLineSpacingMultiplier(lineSpacingMultiplier);
        wv_hours1.setLineSpacingMultiplier(lineSpacingMultiplier);
        wv_mins1.setLineSpacingMultiplier(lineSpacingMultiplier);
        wv_seconds1.setLineSpacingMultiplier(lineSpacingMultiplier);
    }
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_year!=null){
            wv_year1.setLabel(label_year);
        } else {
            wv_year1.setLabel(view.getContext().getString(R.string.pickerview_year));
        }
        ...
        if (label_month!=null){
            wv_month1.setLabel(label_month);
        } else {
            wv_month1.setLabel(view.getContext().getString(R.string.pickerview_month));
        }
        if (label_day!=null){
        ...
        if (label_day!=null){
            wv_day1.setLabel(label_day);
        }else {
            wv_day1.setLabel(view.getContext().getString(R.string.pickerview_day));
        }
        if (label_hours!=null){
        ...
        if (label_hours!=null){
            wv_hours1.setLabel(label_hours);
        } else {
            wv_hours1.setLabel(view.getContext().getString(R.string.pickerview_hours));
        }
        if (label_mins!=null){
        ...
        if (label_mins!=null){
            wv_mins1.setLabel(label_mins);
        }else {
            wv_mins1.setLabel(view.getContext().getString(R.string.pickerview_minutes));
        }
        ...
        if (label_seconds!=null){
            wv_seconds1.setLabel(label_seconds);
        }else {
            wv_seconds1.setLabel(view.getContext().getString(R.string.pickerview_seconds));
        }
    ...
    public void setCyclic(boolean cyclic) {
        ...
        wv_year1.setCyclic(cyclic);
        wv_month1.setCyclic(cyclic);
        wv_day1.setCyclic(cyclic);
        wv_hours1.setCyclic(cyclic);
        wv_mins1.setCyclic(cyclic);
        wv_seconds1.setCyclic(cyclic);
    }
    ...
    public String getTime1() {
        ...
        if (currentYear == startYear) {
           /* int i = wv_month.getCurrentItem() + startMonth;
            System.out.println("i:" + i);*/
            if ((wv_month1.getCurrentItem() + startMonth) == startMonth) {
                sb.append((wv_year1.getCurrentItem() + startYear)).append("-")
                        .append((wv_month1.getCurrentItem() + startMonth)).append("-")
                        .append((wv_day1.getCurrentItem() + startDay)).append(" ")
                        .append(wv_hours1.getCurrentItem()).append(":")
                        .append(wv_mins1.getCurrentItem()).append(":")
                        .append(wv_seconds1.getCurrentItem());
            } else {
                sb.append((wv_year1.getCurrentItem() + startYear)).append("-")
                        .append((wv_month1.getCurrentItem() + startMonth)).append("-")
                        .append((wv_day1.getCurrentItem() + 1)).append(" ")
                        .append(wv_hours1.getCurrentItem()).append(":")
                        .append(wv_mins1.getCurrentItem()).append(":")
                        .append(wv_seconds1.getCurrentItem());
            }
            ...
            sb.append((wv_year1.getCurrentItem() + startYear)).append("-")
                    .append((wv_month1.getCurrentItem() + 1)).append("-")
                    .append((wv_day1.getCurrentItem() + 1)).append(" ")
                    .append(wv_hours1.getCurrentItem()).append(":")
                    .append(wv_mins1.getCurrentItem()).append(":")
                    .append(wv_seconds1.getCurrentItem());
    ...
    public void isCenterLabel(Boolean isCenterLabel) {
        ...
        wv_day1.isCenterLabel(isCenterLabel);
        wv_month1.isCenterLabel(isCenterLabel);
        wv_year1.isCenterLabel(isCenterLabel);
        wv_hours1.isCenterLabel(isCenterLabel);
        wv_mins1.isCenterLabel(isCenterLabel);
        wv_seconds1.isCenterLabel(isCenterLabel);
    }
}
