...
public class CustomHelper {
    ...
    public void MyonClick(View view,TakePhoto takePhoto) {
    ...
    private void configCompress(TakePhoto takePhoto){
        ...
        boolean showProgressBar= rgShowProgressBar.getCheckedRadioButtonId() == R.id.rbShowYes;
        boolean enableRawFile = rgRawFile.getCheckedRadioButtonId() == R.id.rbRawYes;
